...
const GroupDetailsPage = () => {
  ...
  const totals = currentGroup?.totalSpending || {
    totalSpent: 0,
    youOwe: 0,
    youAreOwed: 0,
    settledAmount: 0
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center gap-4 border-b border-glass-stroke pb-2">
            <button
              className={`pb-2 px-1 font-medium text-sm transition-colors ${activeTab === 'expenses'
            ...
            <button
              className={`pb-2 px-1 font-medium text-sm transition-colors ${activeTab === 'settlements'
                ? 'text-primary border-b-2 border-primary'
                : 'text-on-surface-variant hover:text-on-surface'
                }`}
              onClick={() =>
              ...
              isExpensesLoading ? (
                ...
                <div
                  className="
                    ...
                    rounded-xl
                    border border-glass-stroke border-dashed
                  "
                >
                  <Receipt
